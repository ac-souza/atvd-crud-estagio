...
if ($qtd > 0) {
    ...
    while ($row = $res->fetch_object()) {
        ...
        print "<td>
                        ...
                        <button onclick=\"if(confirm('Tem certeza que deseja excluir este veículo?')){location.href='?aba=salvar&acao=excluir&id=" . $row->id . "';}else{false;}\" class='btn btn-danger'>Excluir</button>
                        </td>";
        print "</tr>";
    }
    print "</table>";
